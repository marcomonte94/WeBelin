...
if __name__ == '__main__':
    ...
    parser.add_argument('-g', '--graphic', help='show a bar graphic of resulting releative frequencies', action = 'store_true')
    args = parser.parse_args()
    process(args.infile)

    print('Elapses time: {:.3f}'.format(time.time() - start_time))
